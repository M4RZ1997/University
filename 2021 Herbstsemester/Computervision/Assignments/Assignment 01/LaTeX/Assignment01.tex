			...
			\startsubsection
				...
				\startsubsection
					...
					\begin{enumerate}[(i)]
						\item \textbf{For $u[0,0]$:}
						\begin{align*}
							R_{ATV}^*(u) \ & = \ |u[1,0] - u[0,0]| + |u[0,1] - u[0,0]| + K \\
							\frac{\partial R_{ATV}^*(u)}{\partial u[0,0]} \ & = \ -sign(u[1,0] - u[0,0]) - sign(u[0,1] - u[0,0])
						\end{align*}
						...
						\begin{adjustwidth}{-6em}{}
							\begin{align*}
								\nabla E_{ATV}(u) \ & = \ \frac{1}{2} u[0,0]  + \frac{1}{2} u[1,1] - g[0,0] + \lambda \times (-sign(u[1,0] - u[0,0]) - sign(u[0,1] - u[0,0])) \\
								& = \ \frac{1}{2} u[0,0]  + \frac{1}{2} u[1,1] - g[0,0] - \lambda \times (sign(u[1,0] - u[0,0]) + sign(u[0,1] - u[0,0]))
							\end{align*}
						\closesection
						\item \textbf{For $u[0,n]$:}
						\begin{align*}
							R_{ATV}^*(u) \ & = \ |u[0,n] - u[0,n-1]| + |u[1,n] - u[0,n]| + K \\
							\frac{\partial R_{ATV}^*(u)}{\partial u[0,n]} \ & = \ sign(u[0,n] - u[0,n-1]) - sign(u[1,n] - u[0,n])
						\end{align*}
						\vspace{-0.8cm} \paragraph{Derivative of $\nabla E_{ATV}(u) \ = \ \nabla D_{ii}(u) + \lambda \times \nabla R_{ATV}(u)$}
						\startsubsection
							Adding both derivatives together we will get:
						...
						\begin{adjustwidth}{-8em}{}
							\vspace{-0.5cm}
							\begin{align*}
								R_{ATV}^*(u) \ & = \ |u[m,n] - u[m,n-1]| + |u[m,n] - u[m-1,n]| + K \\
								\frac{\partial R_{ATV}^*(u)}{\partial u[m,n]} \ & = \ sign(u[m,n] - u[m,n-1]) + sign(u[m,n] - u[m-1,n])
							\end{align*}
						\end{adjustwidth}
						\vspace{-0.6cm} \paragraph{Derivative of $\nabla E_{ATV}(u) \ = \ \nabla D_{iv}(u) + \lambda \times \nabla R_{ATV}(u)$}
						\startsubsection
