    ...
    public:
        ...
        virtual void eval_hessian(const Vec &_x, Mat& _h) {
            ...
            for(int i=0; i<ks_.size(); ++i) {
                ...
                //copy to global
                _h(2 * elements_[i].first, 2 * elements_[i].first) += he_(0,0);
                _h(2 * elements_[i].first, 2 * elements_[i].first+1) += he_(0,1);
                _h(2 * elements_[i].first, 2 * elements_[i].second) += he_(0,2);
                _h(2 * elements_[i].first, 2 * elements_[i].second+1) += he_(0,3);

                _h(2 * elements_[i].first+1, 2 * elements_[i].first) += he_(1,0);
                _h(2 * elements_[i].first+1, 2 * elements_[i].first+1) += he_(1,1);
                _h(2 * elements_[i].first+1, 2 * elements_[i].second) += he_(1,2);
                _h(2 * elements_[i].first+1, 2 * elements_[i].second+1) += he_(1,3);

                _h(2 * elements_[i].second, 2 * elements_[i].first) += he_(2,0);
                _h(2 * elements_[i].second, 2 * elements_[i].first+1) += he_(2,1);
                _h(2 * elements_[i].second, 2 * elements_[i].second) += he_(2,2);
                _h(2 * elements_[i].second, 2 * elements_[i].second+1) += he_(2,3);

                _h(2 * elements_[i].second+1, 2 * elements_[i].first) += he_(3,0);
                _h(2 * elements_[i].second+1, 2 * elements_[i].first+1) += he_(3,1);
                _h(2 * elements_[i].second+1, 2 * elements_[i].second) += he_(3,2);
                _h(2 * elements_[i].second+1, 2 * elements_[i].second+1) += he_(3,3);
            }
            //------------------------------------------------------//
        }
