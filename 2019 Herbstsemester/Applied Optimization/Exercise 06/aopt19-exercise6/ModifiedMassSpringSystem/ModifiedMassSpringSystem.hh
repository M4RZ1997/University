...
//== CLASS DEFINITION =========================================================
    ...
    class ModifiedMassSpringSystem {
    public:
        ...
        ModifiedMassSpringSystem(const int _n_grid_x, const int _n_grid_y, const int _spring_element_type = 0) :
                n_grid_x_(_n_grid_x), n_grid_y_(_n_grid_y), n_unknowns_(0), rng_(-1., 1.) {
            setup_spring_graph();
            setup_problem(_spring_element_type);
        }

        ~ModifiedMassSpringSystem(){}
