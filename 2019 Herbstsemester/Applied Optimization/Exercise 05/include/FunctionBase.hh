...
namespace AOPT {
    ...
    public:
        ...
        virtual double f(const Vec &_x, const Vec &_coeffs) = 0;

        // gradient evaluation
        virtual void grad_f(const Vec &_x, Vec &_g) = 0;

        virtual void grad_f(const Vec &_x, const Vec &_coeffs, Vec &_g) = 0;

        // hessian matrix evaluation
        virtual void hess_f(const Vec &_x, Mat &_H) = 0;

        virtual void hess_f(const Vec &_x, const Vec &_coeffs, Mat &_H) = 0;
