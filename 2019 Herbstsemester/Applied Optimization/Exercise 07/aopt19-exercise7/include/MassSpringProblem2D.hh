    ...
    public:
        ...
        virtual void eval_hessian(const Vec &_x, Mat& _h) override {
            ...
            for(int i=0; i<fixed_node_indices_.size(); ++i) {
                ...
                int id1 = 2*fixed_node_indices_[i];
                int id2 = 2*fixed_node_indices_[i]+1;
                ...
                fne_.hess_f(nc_xe_, coeff1, nc_he_);

                //copy to global
                _h(id1, id1) += nc_he_(0,0);
                _h(id1, id2) += nc_he_(0,1);
                _h(id2, id1) += nc_he_(1,0);
                _h(id2, id2) += nc_he_(1,1);
            }
        ...
        virtual void eval_hessian(const Vec &_x, SMat& _h) override {
            ...
            for(int i=0; i<fixed_node_indices_.size(); ++i) {
                ...
                //copy to global
                triplets.push_back(T(id1, id1, nc_he_(0,0)));
                triplets.push_back(T(id1, id2, nc_he_(0,1)));
                triplets.push_back(T(id2, id1, nc_he_(1,0)));
                triplets.push_back(T(id2, id2, nc_he_(1,1)));
            }
        ...
        inline virtual void handle_result(const Vec &_x) override {
            std::cout << "solution converged to x = " << std::endl;
            if (n_unknowns() < 10) {
